 ...
 *
 * Phase 2 (CDN): the only thing that changes is *who* calls setGateBackend —
 * the loader fetches the obfuscated backend bundle and injects it. The
 * getGateBackend() call sites do not move.
 */
