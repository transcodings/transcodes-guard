...
const SKILL_FRONTMATTER =
  '---\nname: transcodes\ndescription: |\n  Create, edit, apply, optimize, or sync a Persona, also called agent config, AI setup, team rules, instructions, agent profile, or AI configuration. Use when the user wants to configure how an AI agent should work, apply team standards to a project or folder, sync settings across AI tools, or manage AGENTS.md, CLAUDE.md, Rules, or Skills as one configuration. Also use for step-up MFA rules, the Transcodes Admin API, step-up state, block checks, and Transcodes SDK integration.\n---\n';
