...
// Shared Agent Skills frontmatter for every supported host.
...
export const HOSTS = [
  {
    name: 'claude-code',
    out: 'plugins/claude-code/skills/transcodes/SKILL.md',
    frontmatter: SKILL_FRONTMATTER,
    introTail:
      " The user's request triggered this skill or follows the /transcodes invocation.",
    requestBlock: '',
  },
  {
    name: 'cursor',
    out: 'plugins/cursor/skills/transcodes/SKILL.md',
    frontmatter: SKILL_FRONTMATTER,
    introTail:
      " The user's request triggered this skill or follows the /transcodes invocation.",
    requestBlock: '',
