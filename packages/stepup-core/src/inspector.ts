 ...
 * holds only the per-prompt grouping sid and the per-coordinate browser latches
 ...
 * timestamps.
 *
 * Strict read-only: never mints a sid, never writes or clears a latch. Expired
...
import { peekPromptSid } from './sid.js';
