...
export const CLI_INSTALL_SH_URL = 'https://raw.githubusercontent.com/transcodings/transcodes-guard/prod/cli/install.sh';
export const CLI_INSTALL_PS1_URL = 'https://raw.githubusercontent.com/transcodings/transcodes-guard/prod/cli/install.ps1';
...
function cliInstallBlurb() {
    return (`Install the CLI (macOS/Linux: \`${CLI_INSTALL_HINT_UNIX}\`; ` +
...
export function formatBlockByPolicyReason(decision) {
    return appendBackendReasoning(`Blocked by transcodes-guard: ${decision.block.reason}. ` +
        ...
        'Do not use get_console_url or auth.transcodes.io for RBAC edits.', decision.reasoning);
}
