 ...
 */
function isRegisteredGuardName(
  toolName: string,
...
export function isGuardToolName(toolName: string): boolean {
 ...
 * mcp__* wire name.
 */
export function isGuardMetaToolName(toolName: string): boolean {
...
const BUILTIN_EXEMPT_BY_PROVIDER: Record<
  GuardProvider,
  readonly BuiltinExemptEntry[]
> = {
...
export function builtinExemptEntries(
  provider: GuardProvider,
): readonly BuiltinExemptEntry[] {
 ...
 */
export function isBuiltinExemptToolName(
