  ...
  server.registerTool(
    ...
    async ({ body }) => {
      ...
      return execProtectedTool('create_role', (sid) =>
        req(config, { method: 'POST', body: { ...body, project_id: config.projectId }, stepUpSid: sid }, 'create_role')
      );
    }
  );
  ...
  server.registerTool(
    ...
    async ({ role_id, body }) => {
      ...
      return execProtectedTool('update_role', (sid) =>
        req(config, { method: 'PUT', body: { ...body, project_id: config.projectId }, stepUpSid: sid }, 'update_role', `/${encodeURIComponent(role_id)}`)
      );
    }
  );
  ...
  server.registerTool(
    ...
    async ({ body }) => {
      ...
      return execProtectedTool('create_resource', (sid) =>
        req(config, { method: 'POST', body: { ...body, project_id: config.projectId }, stepUpSid: sid }, 'create_resource')
      );
    }
  );
  ...
  server.registerTool(
    ...
    async ({ resource_key, body }) => {
      ...
      return execProtectedTool('update_resource', (sid) =>
        req(config, { method: 'PATCH', body: { ...body, project_id: config.projectId }, stepUpSid: sid }, 'update_resource', `/${encodeURIComponent(resource_key)}`)
      );
    }
  );
}
