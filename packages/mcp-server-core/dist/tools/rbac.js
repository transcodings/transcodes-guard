...
export function registerRbacTools(server) {
    ...
    server.registerTool('create_role', {
        ...
        const config = loadStepupConfig();
        return execProtectedTool('create_role', (sid) => req(config, { method: 'POST', body: { ...body, project_id: config.projectId }, stepUpSid: sid }, 'create_role'));
    });
    server.registerTool('update_role', {
        ...
        const config = loadStepupConfig();
        return execProtectedTool('update_role', (sid) => req(config, { method: 'PUT', body: { ...body, project_id: config.projectId }, stepUpSid: sid }, 'update_role', `/${encodeURIComponent(role_id)}`));
    });
    server.registerTool('create_resource', {
        ...
        const config = loadStepupConfig();
        return execProtectedTool('create_resource', (sid) => req(config, { method: 'POST', body: { ...body, project_id: config.projectId }, stepUpSid: sid }, 'create_resource'));
    });
    server.registerTool('update_resource', {
        ...
        const config = loadStepupConfig();
        return execProtectedTool('update_resource', (sid) => req(config, { method: 'PATCH', body: { ...body, project_id: config.projectId }, stepUpSid: sid }, 'update_resource', `/${encodeURIComponent(resource_key)}`));
    });
}
