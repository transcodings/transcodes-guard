    ...
    server.registerTool('add_tool_rule', {
        ...
        inputSchema: {
            ...
            provider: z
                ...
                .optional()
                .describe('Optional MCP host label (claude/codex/cursor/antigravity). Stored for future use; does not affect matching today.'),
    ...
    server.registerTool('update_tool_rule', {
        ...
        inputSchema: {
            ...
            provider: z
                .enum(['claude', 'codex', 'cursor', 'antigravity'])
                .optional()
                .describe('Optional MCP host label. Stored for future use; does not affect matching today.'),
            resource: z
                .string()
                .min(1)
                .optional()
