...
> ~~규모: **M** · 선행: ~~A~~(완료, PR #44)~[C](./C-cdn-loader-cancel.md)(사실상 — 평문 누출 제거가 선행돼야 안전) · 외부 의존: **target public repo·OQ7 결정** · 상태: ⚠️ Blocked (결정)~~
...
- files allowlist 확인.
- 백엔드 endpoint/도구명 잔존은 **metafile/모듈그래프 기준**(grep 보조 — ~~A~~(완료, PR #44)의 "grep unreliable").
