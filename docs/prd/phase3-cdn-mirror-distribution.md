...
| [G](./phase3/G-policy-bundle.md) | **정책 번들 분리** | **L** | — | 백엔드 룰 저장소+CRUD+번들 뷰(사내) | 🔧 **In progress** (G1: #52) |
| [H](./phase3/H-server-decision-done.md) | **결정 권한 봉합** | **S** | — | ~~감사 API~~ 없음(기존 `/v1/audit/logs` 재사용) | ✅ **Ready** |
