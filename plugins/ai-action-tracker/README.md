...
> 현재 MCP 서버는 hello-world 수준입니다. 향후 secrets 검사·MCP 서버 위험 프로파일 등 보안 advisory tool이 추가될 예정 — 리포지토리 [`docs/prd/`](https://github.com/transcodings/ai-action-tracker-mcp/tree/main/docs/prd) 참고.
