...
> 현재 MCP 서버는 hello-world 수준입니다. 향후 secrets 검사·MCP 서버 위험 프로파일 등 보안 advisory tool이 추가될 예정 — 리포지토리 [`docs/prd/`](https://github.com/huskyhoochu/ai-action-tracker/tree/main/docs/prd) 참고.
