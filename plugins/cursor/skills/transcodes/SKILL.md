---
name: transcodes
description: transcodes-guard control surface. Use when the user wants to create, edit, optimize, simplify, or Diet a Persona; manage step-up MFA rules; use the Transcodes Admin API (members, RBAC, org, project, audit, devices); inspect step-up state; check blocks; or integrate the Transcodes SDK.
---
