...
function formatStepupChallengedSystemMessage(decision) {
  ...
  return appendBackendReasoning([
    ...
    '  3. On `outcome: "verified"` retry the SAME Bash command \u2014 the hook detects the verified state and allows it. On `outcome: "timeout"` (decline wiped the session, TTL expired, or wait ended) skip this command and continue other work. Remint only if the user explicitly asks to retry.',
