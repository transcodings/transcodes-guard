...
function formatStepupRejectedSystemMessage(decision) {
  return appendBackendReasoning([
    ...
    `Command: ${decision.block.command}`,
    "",
    "The user rejected WebAuthn for this grouped challenge. Do NOT call `tc_poll_stepup_session_wait` or retry this command unless the user explicitly asks to authenticate again."
  ].join("\n"), decision.reasoning);
}
